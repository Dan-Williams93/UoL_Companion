...
public class custom_list_adapter_socialposts extends ArrayAdapter {
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        View viewRow = inflater.inflate(R.layout.custom_listrow_socialposts, null, true);       //INFLATES THE LIST PLACING THE COMPONENTS OF THE STATED XML FILE IN EACH ROW
